                ...
                <div className="row d-flex justify-content-center">
                    <div className="col-lg-8">
                        ...
                        <section>
                            ...
                            <ul>
                                <li><strong>React.js:</strong> We utilized the React.js framework to create the dynamic and responsive user interface of our website.</li>
                                <li><strong>Bootstrap:</strong> The Bootstrap framework helped us design and structure our web pages efficiently, ensuring a user-friendly experience.</li>
                                <li><strong>Firebase:</strong> We relied on Firebase for data management, authentication, and analytics, enhancing the functionality and security of our services.</li>
                            </ul>
                        </section>
                        <section>
                            <h5>Icon Resources:</h5>
                            <ul>
                                <li><strong>Font Awesome:</strong> We extend our thanks to Font Awesome for providing a comprehensive library of high-quality icons that enhanced the visual elements of our website.</li>
                            </ul>
                        </section>
                        <section>
                            <h5>Graphic Resources:</h5>
                            <ul>
                                <li><strong>Freepik:</strong> We are grateful to Freepik for providing high-quality graphical images and resources that added visual appeal to our website.</li>
                            </ul>
                        </section>
                        <section>
