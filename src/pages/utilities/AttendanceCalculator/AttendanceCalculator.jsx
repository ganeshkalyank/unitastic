        ...
        <div className="row d-flex justify-content-center p-3 mt-5">
          <div className="col-lg-6 container shadow bg-white p-3 rounded-3 bg-white">
            ...
            <button
              ...
              onClick={() => setCanBunk(calculateCanBunk(credits, bunked))}
            >
              Calculate
            </button>
            <hr />
            {canBunk > 0 ? (
              <h5 className="text-center">You can skip {canBunk} classes</h5>
            ) : (
              <h5 className="text-center">You can&apos;t skip any classes</h5>
            )}
          </div>
        </div>
      </div>
